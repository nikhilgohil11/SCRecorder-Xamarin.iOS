...
namespace SCGRecorderBinding
{
	...
	[BaseType (typeof (NSObject))]
	interface SCFilterAnimation : INSCoding {
	...
	[Protocol, Model]
	[BaseType (typeof (NSObject))]
	interface SCFilterDelegate : INSCopying {
...
//		NSDictionary CreateAssetWriterOptionsUsingSampleBuffer (CMSampleBuffer sampleBuffer);
	}
	...
	interface SCVideoConfiguration {
		...
		SCWatermarkAnchorLocation WatermarkAnchorLocation { get; set; }
...
//		void SetImageBySampleBuffer (CMSampleBuffer sampleBuffer);
	...
	interface SCRecorderTools {
		...
		bool FormatInRange (AVCaptureDeviceFormat format, int frameRate,CMVideoDimensions  videoDimensions);
...
//		SCSampleBufferHolder SampleBufferHolderWithSampleBuffer (CMSampleBuffer sampleBuffer);
	}
	...
	interface SCPlayerDelegate {
		...
		void DidPlay (SCPlayer player,CMTime  currentTime, nint loopsCount);
	...
	[BaseType (typeof (SCImageView))]
	interface SCSwipeableFilterView : IUIScrollViewDelegate {
...
//		[iOS (9,0)]
	...
	[BaseType (typeof (NSObject))]
	interface SCRecorder : IAVCaptureAudioDataOutputSampleBufferDelegate, IAVCaptureVideoDataOutputSampleBufferDelegate, IAVCaptureFileOutputRecordingDelegate {
