...
NSString *  const SCContextOptionsCGContextKey = @"CGContext";
NSString *  const SCContextOptionsEAGLContextKey = @"EAGLContext";
NSString *  const SCContextOptionsMTLDeviceKey = @"MTLDevice";
